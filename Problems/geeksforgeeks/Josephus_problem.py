...
permutation) is a theoretical problem. Following is the problem statement:
...
killed. So the person at position 3 survives. If n = 7 and k = 3, then the
safe position is 4. The persons at positions 3, 6, 2, 7, 5, 1 are killed in
